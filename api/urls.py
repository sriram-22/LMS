...
urlpatterns = [path('api/token/', TokenObtainPairView.as_view(), name='token_obtain_pair'),
               ...
               path("student_course_progress_tracking/<int:pk>/", StudentCourseProgressTrackingAPIView.as_view()),
               path("instructor_students_course_progress_tracking/<int:pk>/", InstructorStudentsCourseProgressTrackingAPIView.as_view()),
